...
$(document).ready(function(){
	$(".logo").hide(0).delay(500).fadeIn(500),
	$("footer").hide(0).delay(1500).fadeIn(500),
	$("section.thumbnail").hide(0).delay(2000).fadeIn(500),
	$("section.slider").hide(0).delay(2700).fadeIn(500)
	$("nav").hide(0).delay(3000).fadeIn(500)
 });
